# Consuming Planton Design System in web apps

Read `artifacts/planton-ds/docs/AGENTS.md` first. This guide covers
...
`artifacts/planton-ds/docs/migrating-web.md` before writing UI.
...
```css
@import "@workspace/planton-ds/styles.css";
```
...
`node_modules/@workspace/planton-ds/src/components` to `content`.
...
import {
  toast,
  useToast,
} from "@workspace/planton-ds/hooks/use-toast";
```
...
`@workspace/planton-ds/components/ui/button`. Run the app's typecheck
