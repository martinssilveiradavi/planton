# Consuming Planton Design System in Expo apps

Read `artifacts/planton-ds/docs/AGENTS.md` first. React Native does
...
`artifacts/planton-ds/docs/migrating-expo.md` before writing UI.
...
```tsx
import { tokens } from "@workspace/planton-ds/tokens";
...
```tsx
import { nativeTheme } from "@workspace/planton-ds/lib/native-theme";
import { useColors } from "@workspace/planton-ds/hooks/use-colors";
import { useDesignSystemFonts } from "@workspace/planton-ds/hooks/use-fonts";
```
...
```tsx
import { Badge } from "@workspace/planton-ds/components/native/badge";
import { Button } from "@workspace/planton-ds/components/native/button";
import { Card } from "@workspace/planton-ds/components/native/card";
```
...
Import and render
`@workspace/planton-ds/components/native/button`, then run Expo
