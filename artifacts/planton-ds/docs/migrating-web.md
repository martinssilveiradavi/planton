# Migrating web UI to Planton Design System

Read `artifacts/planton-ds/docs/AGENTS.md` and
`artifacts/planton-ds/docs/consuming-web.md` first. Use this guide
...
- `@/components/ui/<name>` →
  `@workspace/planton-ds/components/ui/<name>`
- `@/lib/utils` (`cn`) → `@workspace/planton-ds/lib/utils`
- `@/hooks/use-toast` → `@workspace/planton-ds/hooks/use-toast`
